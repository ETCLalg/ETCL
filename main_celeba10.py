...
def main(args):
    ...
    data,taskcla,inputsize=celeba.get(seed=args.seed, n_tasks=args.n_tasks, pc_valid=args.pc_valid, idrandom=args.idrandom)
    ...
    for k, ncla in taskcla:
        ...
        data_buffer.append(data_sampler_for_class(data[k]['train']['x'], data[k]['train']['y'], args.sample_size))
...
if __name__ == "__main__":
    ...
    #ETIL parameters 
    parser.add_argument("--sim_threshold", default=0.3, type=float, help="Threshold for ETIL to determine similar tasks.")
    parser.add_argument("--k_threshold", default=0.93, type=float, help="Threshold for choose Orthogonal projection bases of SVD.")
