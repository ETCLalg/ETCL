...
def get(seed=0, pc_valid=0, n_tasks=20, idrandom=3):
    size=[3,32,32]

    data={}
    taskcla=[]

    data_cifar100, taskcla_cifar100, size_cifar100 = read_cifar100(seed=seed, pc_valid=pc_valid, n_tasks=n_tasks//2)
    data_celeba, taskcla_celeba, size_celeba = read_celeba(seed=seed, pc_valid=pc_valid, n_tasks=n_tasks//2)



    all_cifar100 = [data_cifar100[x]['name'] for x in range(n_tasks//2)]
    all_celeba = [data_celeba[x]['name'] for x in range(n_tasks//2)]

    f_name = 'mixceleba_random_'+str(n_tasks)
...
def read_cifar100(seed=0,pc_valid=0.10,n_tasks=10):
    data={}
    taskcla=[]
    size=[3,32,32]
    counter = {}
...
def read_celeba(seed=0,pc_valid=0.10,n_tasks=10):
    data={}
    taskcla=[]
    size=[3, 218, 178]
    size=[3, 32, 32]
