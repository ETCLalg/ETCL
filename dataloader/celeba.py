...
def get(seed=0, idrandom=3, pc_valid=0, n_tasks=10, dataset_size='small'):
    ...
    data_celeba, taskcla_celeba, size_celeba = read_celeba(seed=seed,sim_ntasks=sim_ntasks, data_size=dataset_size, pc_valid=pc_valid)
