...
if __name__ == "__main__":
    ...
    parser.add_argument('--pc_valid',default=0,type=float,
    ...
    # CSNB parameters
    parser.add_argument('--sparsity', type=float, default=0.1, metavar='SPARSITY',
    ...
    #ETIL parameters 
    parser.add_argument("--sim_threshold", default=0.4, type=float, help="Threshold for ETIL to determine similar tasks.")
