...
sim_score_old = np.zeros((10,10))
sim_score_new = np.zeros((10,10))
...
def main(args):
    ...
    data,taskcla,inputsize=femnist_res.get(seed=args.seed, pc_valid=args.pc_valid, idrandom=3, n_tasks=args.n_tasks)
...
if __name__ == "__main__":
    ...
    #ETIL parameters 
    parser.add_argument("--sim_threshold", default=0.57, type=float, help="Threshold for ETIL to determine similar tasks.")
    parser.add_argument("--k_threshold", default=0.9, type=float, help="Threshold for choose Orthogonal projection bases of SVD.")
